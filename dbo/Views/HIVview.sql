...
SELECT DISTINCT 
                         ...
                         b.TEST_LIST, b.Report_Date_Created, b.Report_Type, b.Report_Link, b.Sample_Approved, b.Sample_Reviewed_Date, e1.FORMATTED_ENTRY AS [HIV1-EIA Screen], 
                         e2.FORMATTED_ENTRY AS [HIV 1/2 Differentiation], b.Outbreak
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[HIVview] TO [OSDH\LITS-HIV-SQL]
    AS [dbo];
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Alias = 900
         Table = 1170
         Outp', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'HIVview';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'ut = 720
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'HIVview';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'HIVview';
