...
CREATE  Procedure [dbo].[LilyL_GetLabWareMedicaidBilling]	@StartDate  datetime ,
															@EndDate  datetime
AS
/******************************************************************************
**		File: 
...
INSERT INTO LabWare_Prod_Data.dbo.SUBMISSIONS(SubmissionKey ,
 ...
 SELECT #pmlTemp.LabWareKey + 2000000 AS SubmissionKey ,
   ...
   FROM #pmlTemp INNER JOIN
		HIPPOLYTA.PHOCIS_QUERY.dbo.DEMOGRAPHICS AS dem ON #pmlTemp.DemographicsID = dem.DemographicsID LEFT OUTER JOIN
		HIPPOLYTA.PHOCIS_QUERY.dbo.INSURANCE AS ins ON #pmlTemp.DemographicsID = ins.DemographicsID  
...
GO
GRANT ALTER
    ON OBJECT::[dbo].[LilyL_GetLabWareMedicaidBilling] TO [OSDH\LilyL]
    AS [dbo];
